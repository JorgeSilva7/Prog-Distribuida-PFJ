...
class SensorI(PySensor.Sensor):
    def getTemperature(self, ipPlace, current):
        print(ipPlace[0])
    #def mostrar(self,mensaje,current):
    #    print(mensaje)
...
def run(communicator):
    ...
    adapter = communicator.createObjectAdapter("PySensor.Subscriber")
    ...
    subscriber = adapter.add(SensorI(), subId)
